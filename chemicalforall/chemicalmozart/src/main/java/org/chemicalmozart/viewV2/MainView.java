...
public class MainView extends JFrame {
	...
	public void btnStartReactionAction(){
		...
		this.animatedIcon.setImages(this.animatedIcon.readGifImages("/img/minimozart_anim.gif"));
	...
	public void buildComponents(){
		...
		this.animatedIcon = new JAnimatedIcon("/img/minimozart_anim.gif",20);
	...
	public void endOfReaction() {
		this.animatedIcon.setPause(true);
		this.animatedIcon.setImages("/img/minimozart_grill.gif");
