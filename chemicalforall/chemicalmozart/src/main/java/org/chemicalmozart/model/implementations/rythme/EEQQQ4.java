...
public class EEQQQ4{
	...
	public List<Note> getListNotes() {
		...
		l.add(n1);
		Note n2 = new Note(2, Type.NONE, org.chemicalmozart.model.implementations.Rythme.quater);
		l.add(n2);
		Note n3 = new Note(3, Type.STRONG, org.chemicalmozart.model.implementations.Rythme.quater);
		l.add(n3);
		Note n4 = new Note(4, Type.NONE, org.chemicalmozart.model.implementations.Rythme.quater);
		l.add(n4);
		return l;
	}
}