...
public class QPE2{
	...
	public List<Note> getListNotes() {
		Note n1 = new Note(0, Type.STRONG, org.chemicalmozart.model.implementations.Rythme.quaterdotted);
		Note n2 = new Note(1, Type.BEFORE_STRONG, org.chemicalmozart.model.implementations.Rythme.eighth);
