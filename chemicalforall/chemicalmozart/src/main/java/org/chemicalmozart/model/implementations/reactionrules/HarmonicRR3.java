 ...
 */
public class HarmonicRR3 implements ReactionRule{
	...
	public Object[] computeResult() {
		...
		//Percentages
		int chancesOfGoingOnADegree1 = 30;
		int chancesOfGoingOnADegree2 = 10;
		int chancesOfGoingOnADegree3 = 0;
		int chancesOfGoingOnADegree4 = 30;
		int chancesOfGoingOnADegree5 = 0;
		int chancesOfGoingOnADegree6 = 30;
	...
	public boolean computeSelect() {
		...
		System.out.println("Compute select de HarmonicRR1 : "+(barInCreationInGoodState && (_degree.get_value()==3)));
		return barInCreationInGoodState && (_degree.get_value()==3) && quaterLeftInGoodState;
	}
