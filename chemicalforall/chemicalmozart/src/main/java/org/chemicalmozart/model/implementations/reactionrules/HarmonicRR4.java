 ...
 */
public class HarmonicRR4 implements ReactionRule{
	...
	public Object[] computeResult() {
		...
		int chancesOfGoingOnADegree5 = 60;
	...
	public boolean computeSelect() {
		...
		System.out.println("Compute select de HarmonicRR1 : "+(barInCreationInGoodState && (_degree.get_value()==4)));
		return barInCreationInGoodState && (_degree.get_value()==4) && quaterLeftInGoodState;
	}
