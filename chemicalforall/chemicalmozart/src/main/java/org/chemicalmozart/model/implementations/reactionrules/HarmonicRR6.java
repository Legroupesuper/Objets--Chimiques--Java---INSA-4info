 ...
 */
public class HarmonicRR6 implements ReactionRule{
	...
	public Object[] computeResult() {
		...
		//Percentages
		int chancesOfGoingOnADegree1 = 5;
		int chancesOfGoingOnADegree2 = 15;
		int chancesOfGoingOnADegree3 = 50;
		int chancesOfGoingOnADegree4 = 10;
		int chancesOfGoingOnADegree5 = 20;
		int chancesOfGoingOnADegree6 = 0;
	...
	public boolean computeSelect() {
		...
		System.out.println("Compute select de HarmonicRR1 : "+(barInCreationInGoodState && (_degree.get_value()==6)));
		return barInCreationInGoodState && (_degree.get_value()==6)&& quaterLeftInGoodState;
	}
