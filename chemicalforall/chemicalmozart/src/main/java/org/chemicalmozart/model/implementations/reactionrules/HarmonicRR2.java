...
public class HarmonicRR2 implements ReactionRule{
	...
	public Object[] computeResult() {
		...
		int chancesOfGoingOnADegree3 = 40;
		int chancesOfGoingOnADegree4 = 50;
	...
	public boolean computeSelect() {
		...
		System.out.println("Compute select de HarmonicRR1 : "+(barInCreationInGoodState && (_degree.get_value()==2)));
		return barInCreationInGoodState && (_degree.get_value()==2) && quaterLeftInGoodState;
	}
