...
public class SSEQQEE4{
	...
	public List<Note> getListNotes() {
		...
		l.add(n3);
		Note n4 = new Note(4, Type.STRONG, org.chemicalmozart.model.implementations.Rythme.quater);
		l.add(n4);
		Note n5 = new Note(5, Type.NONE, org.chemicalmozart.model.implementations.Rythme.eighth);
		l.add(n5);
		Note n6 = new Note(6, Type.NONE, org.chemicalmozart.model.implementations.Rythme.eighth);
		l.add(n6);
		return l;
	}
}