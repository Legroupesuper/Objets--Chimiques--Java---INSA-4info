...
public class EESSEQSSE4{
	...
	public List<Note> getListNotes() {
		...
		l.add(n4);
		Note n5 = new Note(5, Type.STRONG, org.chemicalmozart.model.implementations.Rythme.quater);
		l.add(n5);
		Note n6 = new Note(6, Type.NONE, org.chemicalmozart.model.implementations.Rythme.sixteenth);
		l.add(n6);
