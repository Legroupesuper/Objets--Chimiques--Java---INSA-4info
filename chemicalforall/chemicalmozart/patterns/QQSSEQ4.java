...
public class QQSSEQ4{
	...
	public List<Note> getListNotes() {
		...
		l.add(n1);
		Note n2 = new Note(2, Type.STRONG, org.chemicalmozart.model.implementations.Rythme.sixteenth);
		l.add(n2);
		...
		l.add(n4);
		Note n5 = new Note(5, Type.NONE, org.chemicalmozart.model.implementations.Rythme.quater);
		l.add(n5);
		return l;
	}
}