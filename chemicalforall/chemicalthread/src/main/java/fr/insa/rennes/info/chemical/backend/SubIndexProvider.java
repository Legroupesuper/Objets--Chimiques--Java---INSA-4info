...
public interface SubIndexProvider {
	 ...
	 * the number resulting of the multiplication of the number of each reactive that could be matched.<br />
	 * The {@link BigInteger} is justified by the possibly great number of combinations. For instance,
	 * a sub index provider for 6 different types of reactives in a solution containing 70 instances of 
	 ...
	 * are said dependent when they are pointing on the same type of object/reactive, in the same solution.
